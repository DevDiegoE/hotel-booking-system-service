...
bookingRoutes.post('/', validateRequest(bookingSchema), bookingController.create);
bookingRoutes.get('/', bookingController.getAll);
bookingRoutes.get('/:id', bookingController.getById);
bookingRoutes.put('/:id', validateRequest(bookingSchema.optional()), bookingController.update);
bookingRoutes.delete('/:id', bookingController.deleteById);
